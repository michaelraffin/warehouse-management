    ...
    <>
      <div className="text-lg col-auto ml-4 ">
        ...
        <div className="mt-2 ml-20">
          <span className="text-[24px]">👋 Setup your account</span>
        </div>
        <div
          className={`mt-2 lg:ml-20 ml-4 lg:mr-0 mr-20 ${status ? "opacity-50 " : ""}`}
        >
          <label className="block mb-2 mt-20 text-sm font-xs text-gray-900 dark:text-white">
            First name
          </label>
      ...
      <path d="M11.241 9.817c-.36.275-.801.425-1.255.427-.428 0-.845-.138-1.187-.395L0 2.6V14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2.5l-8.759 7.317Z"/>
          ...
          <label className="block mb-2 mt-4 text-sm font-xs text-gray-900 dark:text-white">
            Last name
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
      ...
      <path d="M11.241 9.817c-.36.275-.801.425-1.255.427-.428 0-.845-.138-1.187-.395L0 2.6V14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2.5l-8.759 7.317Z"/>
          ...
          <div className="mt-10 mb-10">
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Warehousemen" id="Warehousemen" />
                <Label htmlFor="option-two">Warehousemen</Label>
              </div>
              <div className="flex items-center space-x-2">
          ...
          >
            {status ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}{" "}
            Continue
          </Button>
        </div>
