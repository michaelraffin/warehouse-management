...
import {
  ...
  <div className="w-full mb-20">
        ...
        <article class="rounded-lg border border-gray-100 bg-white p-6 hover:shadow-lg">
  <div>
  ...
  <div class="mt-1 flex gap-1 text-red-600">
    ...
    <p class="flex gap-2 text-xs">
      ...
      <span class="text-gray-500"> Since last week </span>
          ...
          <Tabs defaultValue="account" className="w-full ml-24 bt-20 bg-white rounded-lg">
