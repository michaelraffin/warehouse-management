...
const chartData = [
  ...
  // { date: "2024-06-19", desktop: 341, mobile: 0 },
  // { date: "2024-06-20", desktop: 408, mobile: 0 },
  // { date: "2024-06-21", desktop: 169, mobile: 0 },
  // { date: "2024-06-22", desktop: 317, mobile: 0 },
  // { date: "2024-06-23", desktop: 480, mobile: 0 },
  // { date: "2024-06-24", desktop: 132, mobile: 0 },
  // { date: "2024-06-25", desktop: 0, mobile: 0 },
  // { date: "2024-06-26", desktop: 0, mobile: 0 },
  // { date: "2024-06-27", desktop: 0, mobile: 490 },
...
export function MainChart({ chartTitle, data }: MainChartProps) {
  const updateData = (data: any, chartData: any) => {
    try {
      let result = data.map((product: ProductDetails) => ({
        date: moment(product.dateAdded).format("YYYY-MM-DD").toString(),
        ...
        >
          ...
          >
            ...
            <XAxis
              ...
              minTickGap={32}
              tickFormatter={(value) => {
                console.log("XAxis ChartTooltipContent", value);
                return value;
              }}
            />
            <ChartTooltip
