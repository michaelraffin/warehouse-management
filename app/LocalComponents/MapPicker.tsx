...
import { Container, ClickCoordinatesContainer, CustomMap } from '../LocalComponents/mapComponents/styles';
...
const Map: React.FC<IMap> = ({ mapId, width, height, lng, lat, zoom, markers }) => {
  ...
  // mapboxApiAccessToken={"eyJ1IjoibWFtbmlkeiIsImEiOiJjanZsNnhhZ24wdDE1NDlwYmRvczJzNDk2In0.Bl06Qp0TgR-KfisAsKbciQ"}
  // />
  //   }
    // const Map = new mapboxgl.Map({
    //       container:'map',
    //       mapboxAccessToken: "pk.eyJ1IjoibWFtbmlkeiIsImEiOiJjanZsNnhhZ24wdDE1NDlwYmRvczJzNDk2In0.Bl06Qp0TgR-KfisAsKbciQ",
    ...
    useEffect(() => {
      ...
      const map = new mapboxgl.Map({
        container:'pk.eyJ1IjoibWFtbmlkeiIsImEiOiJjanZsNnhhZ24wdDE1NDlwYmRvczJzNDk2In0.Bl06Qp0TgR-KfisAsKbciQ',
        style: 'mapbox://styles/mapbox/streets-v11',
        center: [mapCoordinates.lng, mapCoordinates.lat],
        zoom: mapZoom,
      });
