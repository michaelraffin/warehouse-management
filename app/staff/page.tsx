...
const staff = [
  { id: 1, name: "Michael", category: "Agent" },
  { id: 2, name: "Raffin", category: "Warehouse" },
  { id: 23, name: "Michael", category: "Agent" },
  { id: 123, name: "Michael", category: "Agent" },
  ,
  { id: 112323, name: "Mai mai", category: "Agent" },
  { id: 14132123, name: "james", category: "Agent" },
];
const invoices = [
  {
    invoice: "INV001",
...
export default function StaffComponent() {
  ...
  return (
    <div className="">
      ...
      <Tabs
        defaultValue="Stockman"
        className="w-full ml-24 bt-20 bg-white rounded-lg"
      >
        <TabsList className="rounded-full">
          ...
          <TabsTrigger className="rounded-full" value="Stockman">
            Stockman
          </TabsTrigger>
          <TabsTrigger className="rounded-full" value="Cashier">
            Cashier
          </TabsTrigger>
          <TabsTrigger className="rounded-full" value="Agent">
            Agent
          </TabsTrigger>
        </TabsList>
